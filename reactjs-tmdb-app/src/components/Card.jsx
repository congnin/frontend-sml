...
function Card(props) {
  ...
  return (
    <div className='row cardcont nopadding'>
      <div className='poster-container nopadding col-sm-6 col-md-4 pull-md-8 col-lg-5 pull-lg-7 '>
        <img id='postertest' className='poster' src={posterIMG} alt='' />
      </div>
      <div className='meta-data-container col-sm-6 col-md-8 push-md-4 col-lg-7 push-lg-5'>
        ...
        <div className='additional-details'>
          ...
          <div className='row nopadding release-details'>
            ...
            <div className='col-sm'>
              Countries:{' '}
              <span className='meta-data'>{productionCountriesList}</span>
            </div>
          </div>
        </div>
      </div>
